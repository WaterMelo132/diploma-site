...
<head>
    ...
    <title>Voyger - Регистрация</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <script>
        ...
        document.addEventListener('keydown', function(event) {
            ...
            if (isAKeyPressed && isDKeyPressed) {
                document.getElementById('secret_code_field').style.display = 'block';
            }
        });
    ...
    <div class="left-panel">
        <div class="left-panel-content">
            ...
            <form action="" method="POST">
                ...
                <div id="secret_code_field">
                    <div class="form-group">
                        <input type="text" name="secret_key" placeholder="Секретный код">
                    </div>
                </div>
